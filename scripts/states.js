/**
 * Source:
 * curl -LO https://api.census.gov/data/2019/acs/acsse?get=NAME,K200101_001E&for=state:*"
 * Meaning of population query:
 * https://api.census.gov/data/2017/acs/acsse/variables.html#K200101_001E
 * For available api variables (caution: large file > 13 MB):
 * https://api.census.gov/data/2019/acs/acs1/variables.json
 */
export default [
["NAME","K200101_001E","state"],
